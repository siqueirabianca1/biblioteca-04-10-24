...
--
-- Host: 127.0.0.1
-- Tempo de geração: 04-Out-2024 às 20:45
...
(15245, '2024-10-01', '2024-10-04', 8, 2),
(35678, '2024-10-10', '2024-10-16', 5, 4),
(84593, '2024-10-15', '2024-10-18', 1, 3),
(89567, '2024-09-02', '2024-09-09', 7, 1);
...
(3, 'Ordinael', '1999-02-21', '(81 976890987)', 'ordina@gmail.com', 14678, 'Rua carpinna', '12', 'janga', 'paulistap-pe'),
(4, 'Bianca', '2007-02-04', '(81 99990-4508)', 'bianca@gmail.com', 96789, 'Rua américa', '16', 'caetes', 'abreu-pe');
...
(1, 'Pequeno principe', 'Antoine de Saint-Exupéry', 'HarperCollins Brasil', 'muito bom', 1994, 'fantasia', 96),
(5, 'Assim que acaba', 'O Rei Leão', 'Roger Allers', ' Walt Disney', 0, '1945', 0),
(6, 'Assim que começa', 'joseph', 'Bryan', 'muito bom', 1989, 'ação', 56),
(7, 'A bela e a fera', 'Charlie', 'Kimberly', 'muito dinâmico', 1999, 'fantasia', 70),
(8, 'acotar', 'Alana', 'Laysa', 'muito maravilhoso', 200, 'aventura', 60);
...
--
ALTER TABLE `emprestimos`
  MODIFY `CodEmprestimo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=89568;

--
-- AUTO_INCREMENT de tabela `leitores`
--
ALTER TABLE `leitores`
  MODIFY `CodLeitor` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
